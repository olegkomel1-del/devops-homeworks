...
## Сериншот выполнения из SQL запроса  

![Сериншот выполнения из SQL запроса ](https://github.com/user-attachments/assets/65d0f661-4622-44c4-865d-8c38e2df3e7d)
  
  В ходе выполнения задания стандартный образ mysql:8 был заменен на полностью совместимый mariadb:10.11 из-за аппаратных ограничений процессорной архитектуры на хост-машине:  
  Требование к x86-64-v2: Начиная с версии MySQL 8.0.26+, официальные сборки и Docker-образы компилируются с жестким требованием к поддержке процессором инструкций уровня x86-64-v2 (включая SSE3, SSSE3, SSE4.1, SSE4.2 и POPCNT).
